...
public class TestNonClinicalStaffWithInSuranceClassUnCheckedAndClinicalSetupUnChecked extends TestSetUp {
	// TC-49 DO NOT Allow Non-Clinical Staff to finalize Visit notes
	// TC-50 Allow Non-Clinical Staff to finalize Non Visit notes
	// TC-51 Allow Non-Clinical Staff to finalize Non Visit-DISCHARGE notes
	...
	public void DONOTAlowNonClinicalStafToFinalizeVisitNotes() throws InterruptedException {
		test = extent.startTest(
				"DO NOT Allow Non clinical staff to finalize Visit notes with allow Non-Clinical Staff Note Sign in clinic setup :  Un-CHECKED and 'Don't allow Non-Clinical Staff Note Sign' on insurance class:  UNCHECKED ",
				"DO NOT Allow Non clinical staff to finalize Visit notes with allow Non-Clinical Staff Note Sign in clinic setup :  Un-CHECKED and 'Don't allow Non-Clinical Staff Note Sign' on insurance class:  UNCHECKED "
	...
	public void AllowNonClinicalStaffToFINALIZENOnVisitNotes() throws InterruptedException {
		test = extent.startTest(
				"Allow Non clinical staff to finalize NonVisit  notes with  allow Non-Clinical Staff Note Sign in clinic setup :  Un-CHECKED 'Don't allow Non-Clinical Staff Note Sign' on insurance class:  UNCHECKED",
				"Allow Non clinical staff to finalize NonVisit  notes with  allow Non-Clinical Staff Note Sign in clinic setup :  Un-CHECKED 'Don't allow Non-Clinical Staff Note Sign' on insurance class:  UNCHECKED"
						+ "*****Current Browser******" + CurrentBrowserName + "*****Browser Version******"
						+ caps.getVersion());
		test.assignCategory("Regression", "On" + "  " + CurrentBrowserName,
	...
	public void AllowNonclinicalstaffToFinalizNonVisitDischargenotes() throws InterruptedException {
		test = extent.startTest(
				"Allow Non clinical staff to finalize Non visit discharge  notes with  allow Non-Clinical Staff Note Sign in clinic setup :  Un-CHECKED 'Don't allow Non-Clinical Staff Note Sign' on insurance class:  UNCHECKED",
				"Allow Non clinical staff to finalize Non visit discharge  notes with  allow Non-Clinical Staff Note Sign in clinic setup :  Un-CHECKED 'Don't allow Non-Clinical Staff Note Sign' on insurance class:  UNCHECKED"
						+ "*****Current Browser******" + CurrentBrowserName + "*****Browser Version******"
						+ caps.getVersion());
		test.assignCategory("Regression", "On" + "  " + CurrentBrowserName,
