...
public class TestHardStopMessagevalidation extends TestSetUp {
	@Test(enabled = true, priority = 1)
	public void TestHardStopWith97001() throws InterruptedException {
		test = extent.startTest(
				"To verify Hard Stop message while create and finalize initial visit WITHOUT FLR and WITH 97001",
				"Test Hard Stop message With 97001" + "*****Current Browser******" + CurrentBrowserName
