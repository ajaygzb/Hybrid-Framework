...
public class TestHardStopMessagevalidation2 extends TestSetUp {
	@Test(enabled = true, priority = 1)
	public void TestHardStopWithout97001() throws InterruptedException {
		test = extent.startTest(
				"To verify Hard Stop message while create and finalize initial visit WITHOUT FLR and WITHOUT 97001",
				"Test Hard Stop message Without 97001" + "*****Current Browser******" + CurrentBrowserName
