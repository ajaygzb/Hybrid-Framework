...
public class TestPQRSHardstop extends TestSetUp {
	// TC-Patient AGE between 18 -64 years old PT provider
	// TC-Patient AGE over 64 years old
	public String strActualtext = null;
	public List<WebElement> actual = null;

	@Test(enabled = true, priority = 1)
	public void PQRS_HardStop_ViewPastData_PT() throws InterruptedException {
		...
		try {
			...
			String[] expected1 = { "126", "127", "128", "130", "131", "182" };
			for (int i = 0; i < 6; i++) {
			...
			ActionUtils.click(driver.findElement(By.xpath("//div[@id='PQRS']//span[contains(@class,'glyphicon glyphicon-minus')]")));
			// Add measures 130
			ActionUtils.click(driver.findElement(
			...
			ActionUtils.click(driver.findElement(By.xpath(
					"//option[@label='G8541 - FUNCTIONAL OUTCOME ASSESSMENT USING A STANDARDIZED TOOL NOT DOCUMENTED, REASON NOT GIVEN']")));
			ActionUtils.click(driver.findElement(By.xpath("//span[contains(@class,'glyphicon glyphicon-minus')]")));
