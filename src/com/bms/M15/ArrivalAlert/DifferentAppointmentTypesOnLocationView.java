...
public class DifferentAppointmentTypesOnLocationView extends TestSetUp {
	@Test(enabled = true, priority = 1)
	public void TestCancelationOnLocationView() {
		test = extent.startTest(
				"To Verify a self pay case is created if user approve charge added in policy charge queue , patient view (cancel)",
				"Test Cancelation On Location View" + "*****Current Browser******" + CurrentBrowserName
		...
		try {
			...
			AddScheduleUtils.SelectViewBy(driver, "Location View","BMS_Automation_2");
			System.out.println("open location view of patient :" + newName);
			test.log(LogStatus.INFO, "open location view of patient :" + newName);
			...
			test.log(LogStatus.INFO, "Test:::: TestCancelationOnLocationView Completed as Fail");
	...
	public void TestNoShowOnLocationView() {
		test = extent.startTest(
		...
		try {
			...
			dropdown.selectByVisibleText("Location View");
			...
			dropdown.selectByVisibleText("BMS_Automation_2");
			Commons.waitForLoad(driver);
			Thread.sleep(3000);
			System.out.println("open location view of patient :" + newName);
			test.log(LogStatus.INFO, "open location view of patient :" + newName);
			...
			test.log(LogStatus.INFO, "Assertion Error!!!" + e);
			test.log(LogStatus.INFO, "Test:::: TestNoShowOnLocationView Completed as Fail");
			Assert.assertFalse(true, Throwables.getStackTraceAsString(e));
		} catch (Exception e) {
			test.log(LogStatus.INFO, " Error!!!" + e);
			test.log(LogStatus.INFO, "Test:::: TestNoShowOnLocationView Completed as Fail");
	...
	public void TestGroupAppointmnetOnLocationView() {
		test = extent.startTest("group appointmnet is created on location view ", "Test Cancelation On Location View"
		...
		try {
			...
			Commons.logintoRevflow(driver, Commons.readPropertyValue("userPolicycharge"),
					Commons.readPropertyValue("password"));
			test.log(LogStatus.INFO, "naviagting to location view ");
			ActionUtils.click(SchedulerPage.ScheduleOnMenu(driver));
			ActionUtils.click(SchedulerPage.ViewScheduleButton(driver));
			Commons.waitForElementToBeNotVisible(driver, By.xpath("//span[contains(text(),'Loading')]"), 60);
			Commons.waitForElementToBeNotVisible(driver, By.xpath("//*[@id='mySpinner']"), 200);
			...
			Commons.waitForLoad(driver);
			Thread.sleep(3000);
			System.out.println("open location view ");
			test.log(LogStatus.INFO, "open location view ");
			System.out.println("creating group appointmnet on location view ");
			test.log(LogStatus.INFO, "creating group appointment  on location view ");
			// adding appointment
			AddScheduleUtils.GotoAppointmentWindow(driver);
			...
			test.log(LogStatus.INFO, "Assertion Error!!!" + e);
			test.log(LogStatus.INFO, "Test:::: TestGroupAppointmnetOnLocationView Completed as Fail");
			Assert.assertFalse(true, Throwables.getStackTraceAsString(e));
		} catch (Exception e) {
			test.log(LogStatus.INFO, " Error!!!" + e);
			test.log(LogStatus.INFO, "Test:::: TestGroupAppointmnetOnLocationView Completed as Fail");
	...
	public void TestArrivalAppointmnetOnLocationView() {
		test = extent.startTest(
				"To Verify arrival Alert pop up pops on Screen when Additional Arrival alerts are checked and on clicking on dismiss button alert dismiss on location view",
				"Test Arrival Appointmnet On Location View" + "*****Current Browser******" + CurrentBrowserName
						+ "*****Browser Version******" + caps.getVersion());
		test.assignCategory("Regression", "On" + "  " + CurrentBrowserName,
				this.getClass().getPackage().getName().toString());
		test.log(LogStatus.INFO, "Browser started");
		...
		try {
			...
			try {
				...
				test.log(LogStatus.INFO, " Error!!!" + e);
				test.log(LogStatus.INFO, "Test:::: TestArrivalAppointmnetOnLocationView Completed as Fail");
				Assert.assertFalse(true, Throwables.getStackTraceAsString(e));
			}
