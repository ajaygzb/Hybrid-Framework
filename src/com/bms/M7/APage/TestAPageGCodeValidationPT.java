...
public class TestAPageGCodeValidationPT extends TestSetUp {
	// 5,11,17,23,29 inscode
	// 1,7,13,19,25 lastname
	public String strText_Actual;

	@Test(enabled = true, priority = 1)
	public void G_CodeValidation_PT() throws InterruptedException {
		try {
			test = extent.startTest(
					"Current status drop down - available options per discipline (PT) for Medicare Patient",
					"Test available options per discipline (PT) " + "*****Current Browser******" + CurrentBrowserName
